...
@Entity("tblWHConfirmGoodsReceiveDetail", { schema: "dbo" })
export class TblWhConfirmGoodsReceiveDetail {
  ...
  @Column("datetime", { name: "ExpectedDate", nullable: true })
  ...
  @Column("int", { name: "AvailableQuantity", nullable: true })
  ...
  @Column("bit", { name: "StatusAvailable" })
